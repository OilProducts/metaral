...
static void ImGui_ImplSDL3_SetPlatformImeData(ImGuiViewport*, ImGuiPlatformImeData* data)
{
    ...
    if (data->WantVisible)
    {
        ...
        SDL_SetTextInputArea(bd->Window, &r, -1);
...
bool ImGui_ImplSDL3_ProcessEvent(const SDL_Event* event)
{
    ...
    switch (event->type)
    {
        ...
        case SDL_EVENT_KEY_UP:
        {
            ...
            io.SetKeyEventNativeData(key, event->key.key, scancode, scancode); // To support legacy indexing (<1.87 user code). Legacy backend uses SDLK_*** as indices to IsKeyXXX() functions.
            return true;
        }
